...
8.3 Over time
```{r}
#Notice how averages change over time! We need to incorporate this into our priors.
career2 %>%
  ...
  geom_boxplot() +
  theme_few() +
  expand_limits(ymin = 0, ymax = 0.4) +
  labs(title = "Batting averages across decades",
       x = "Decade",
       y = "Batting ave.")
